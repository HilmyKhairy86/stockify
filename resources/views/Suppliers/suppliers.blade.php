    ...
    <x-slot name="header">
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto md:px-5 sm:px-5 lg:px-5">
                ...
                <div class="mb-5 border dark:border-gray-800 dark:bg-gray-800 rounded-lg shadow-lg bg-white border-gray-200">
                    <div class="p-5">
                        <h2 class="mb-2 text-5xl font-bold text-gray-900 dark:text-white">Suppliers</h2>
        ...
        @if (session('success'))
            <div x-data="{ isOpen: true }" 
                ...
                x-bind:class="{ 'overflow-y-hidden': isOpen }">
                <!-- Modal Backdrop -->
                <div 
                    x-show="isOpen" 
                ...
                >
                    ...
                    <div 
                        ...
                        class="relative p-6 w-full max-w-2xl bg-white rounded-lg shadow dark:bg-gray-700"
                    >
                        <!-- Modal Header -->
