                        ...
                        <div class="w-full md:w-1/2">
                            {{-- search --}}
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input autocomplete="off" type="text" id="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                                </div>
                                                    ...
                                                    <form action="{{ route('updateProduct', $d->id) }}" method="POST">
                                                        ...
                                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="file" name="image" id="" value="{{ $d->image }}">
                                                            </div>
                                ...
                                $('#search').on('keyup', function() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            $('#table-body').empty(); // Clear current rows
                                            ...
                                            if (data.length > 0) {
                                                data.forEach(product => {
                                                    $('#table-body').append(`
                                                        <tr>
                                                            <td class="px-4 py-3"></td>
                                                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">${ products.name }</th>
                                                            <td class="px-4 py-3">${ product.category_id }</td>
                                                            <td class="px-4 py-3">${ product.supplier_id }</td>
                                                ...
                                                $('#table-body').append('<tr><td colspan="3" class="text-center px-4 py-2 border">No Product found</td></tr>');
                                            }
                                        },
                                        error: function(xhr) {
                ...
                <div class="relative p-4 w-full max-w-lg h-full md:h-auto">
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 md:p-8">
                        <div class="mb-4 text-sm font-light text-gray-500 dark:text-gray-400">
                            <h3 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">Success</h3>
                            <p>
                                Success
                            </p>
                        </div>
