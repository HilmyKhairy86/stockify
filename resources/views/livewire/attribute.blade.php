            ...
            <div x-data="{ adddatamodal: false }" x-cloak="{display: none}" x-init="open = false" @keydown.escape.window="open = false" x-bind:class="{ 'overflow-hidden': open }"  class="relative">
                ...
                <div x-show="adddatamodal" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="flex justify-between items-center">
                        <h5 id="drawer-label" class="text-sm font-semibold text-gray-900 uppercase dark:text-gray-400 mb-5">New Attribute</h5>
                    ...
                    <div class="h-full overflow-y-auto">
                        ...
                        <form action="{{ route('addAttribute') }}" method="POST">
                            ...
                            <button type="submit" class="text-gray-900 border rounded-md inline-flex items-center px-5 py-2.5 text-center border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
